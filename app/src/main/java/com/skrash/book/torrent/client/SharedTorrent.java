...
import com.skrash.book.torrent.client.common.TorrentInfo;
...
import com.skrash.book.torrent.client.storage.TorrentByteStorage;
import com.skrash.book.torrent.client.strategy.EndGameStrategy;
import com.skrash.book.torrent.client.strategy.EndGameStrategyImpl;
import com.skrash.book.torrent.client.strategy.RequestStrategy;
import com.skrash.book.torrent.client.strategy.RequestStrategyImplAnyInteresting;
import com.skrash.book.torrent.client.strategy.RequestsCollection;
import com.skrash.book.torrent.client.strategy.RequestsCollectionImpl;
...
public class SharedTorrent implements PeerActivityListener, TorrentMetadata, TorrentInfo {
  ...
  @Override
  public com.skrash.book.torrent.client.common.Optional<Long> getCreationDate() {
    return myTorrentMetadata.getCreationDate();
  }

  @Override
  public com.skrash.book.torrent.client.common.Optional<String> getComment() {
    return myTorrentMetadata.getComment();
  }

  @Override
  public com.skrash.book.torrent.client.common.Optional<String> getCreatedBy() {
