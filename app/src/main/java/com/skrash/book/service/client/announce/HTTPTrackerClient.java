 ...
 */
package com.skrash.book.service.client.announce;

import com.skrash.book.service.client.bcodec.BDecoder;
import com.skrash.book.service.client.bcodec.BEValue;
...
import com.skrash.book.service.client.common.protocol.TrackerMessage;
import com.skrash.book.service.client.common.protocol.http.HTTPAnnounceRequestMessage;
import com.skrash.book.service.client.common.protocol.http.HTTPAnnounceResponseMessage;
import com.skrash.book.service.client.common.protocol.http.HTTPTrackerMessage;
...
public class HTTPTrackerClient extends TrackerClient {
  ...
  private URL encodeAnnounceToURL(AnnounceRequestMessage.RequestEvent event, AnnounceableInformation torrentInfo, Peer peer) throws AnnounceException {
    ...
    try {
      ...
      throw new AnnounceException("Invalid announce URL (" +
              mue.getMessage() + ")", mue);
    } catch (PeerMessage.MessageValidationException mve) {
   ...
   * @throws IOException
   * @throws PeerMessage.MessageValidationException
   */
  private HTTPAnnounceRequestMessage buildAnnounceRequest(
          ...
          throws IOException,
          PeerMessage.MessageValidationException {
  ...
  private interface ResponseParser {
    ...
    void parse(InputStream inputStream, int responseCode) throws IOException, TrackerMessage.MessageValidationException;
