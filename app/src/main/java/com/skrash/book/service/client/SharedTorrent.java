...
import com.skrash.book.service.client.common.TorrentInfo;
...
import com.skrash.book.service.client.common.TorrentUtils;
...
import com.skrash.book.service.client.storage.TorrentByteStorage;
import com.skrash.book.service.client.strategy.EndGameStrategy;
import com.skrash.book.service.client.strategy.EndGameStrategyImpl;
import com.skrash.book.service.client.strategy.RequestStrategy;
import com.skrash.book.service.client.strategy.RequestStrategyImplAnyInteresting;
import com.skrash.book.service.client.strategy.RequestsCollection;
import com.skrash.book.service.client.strategy.RequestsCollectionImpl;
...
public class SharedTorrent implements PeerActivityListener, TorrentMetadata, TorrentInfo {
  ...
  @Override
  public com.skrash.book.service.client.common.Optional<Long> getCreationDate() {
    return myTorrentMetadata.getCreationDate();
  }

  @Override
  public com.skrash.book.service.client.common.Optional<String> getComment() {
    return myTorrentMetadata.getComment();
  }

  @Override
  public com.skrash.book.service.client.common.Optional<String> getCreatedBy() {
