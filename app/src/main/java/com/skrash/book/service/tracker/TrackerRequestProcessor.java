 ...
 */
package com.skrash.book.service.tracker;

import com.skrash.book.service.client.Constants;
...
import com.skrash.book.service.client.common.protocol.http.HTTPTrackerErrorMessage;
...
public class TrackerRequestProcessor {
  ...
  public void process(final String uri, final String hostAddress, RequestHandler requestHandler)
    ...
    if (!myAcceptForeignTorrents && torrent == null) {
      ...
      serveError(Status.BAD_REQUEST, TrackerMessage.ErrorMessage.FailureReason.UNKNOWN_TORRENT, requestHandler);
      return;
    }
    ...
    try {
      ...
      serveError(Status.BAD_REQUEST, TrackerMessage.ErrorMessage.FailureReason.INVALID_EVENT, requestHandler);
      return;
    }
